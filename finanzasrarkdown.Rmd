---
title: "Introduccion a finanzas con R"
author: "Ramiro Jimenez-Caroll Cuesta"
date: "10/2/2021"
...
##Analisis General
Este script tiene como objetivo introducirnos en el universo de las finanzas cuantitativas utilizando Rstudio.
...
Las preguntas¿Qué acciones tengo que mirar? o ¿qué sector me conviene operar? pueden resumir esta sitaución.
...
```{r cars}
##Generamos nuestro vector de indices y activos.
...
##Ahora otbenemos la información reativa a cada uno creando un listado de los mismos.
...
##Generamos nuestro vector de etfs.
##Pero al reunir 12 símbolos no parece conveniente en este caso reunirlos en un documento de una carilla. En lugr de ello, generaremos un documento más extenso respecto a sus carillas pero con mayor información para el análisis técnico ya que incorporaremos el indicador MACD.
